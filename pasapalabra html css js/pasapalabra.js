...
const questions = [
    ...
    },
    {
        ...
        answer: 'empanada',
        status: STATUS_UNANSWERED,
        question: 'CON LA E. Alimento muy popular en Galicia',
    },
    {
        letterID: 'F',
        letter: 'f',
...
const userFinished = () => {
    document.querySelector(
        '#feedback'
    ).innerText = `¡Felicidades! Has terminado con una puntuación de ${players[0].score} y ${players[0].fails} fallos.`;
...
const userDidNotFinish = () => {
    document.querySelector(
        '#feedback'
    ).innerText = `Has terminado el juego con una puntuación de ${players[0].score} y ${players[0].fails} fallos. Hasta pronto.`;
